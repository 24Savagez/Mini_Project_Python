...
# read the data
X_full = pd.read_csv("Train_60min_BTC_USD.csv")
X_test = pd.read_csv("Test_60min_BTC_USD.csv")
...
# print(prediction_euusd)
# check result
close_test = pd.read_csv("Check_60min_BTC_USD.csv")
